...
<html lang="en" style="background:#F7F7F7">
  ...
  <body>
  <form method="post" action="Assistant_DossierPatient?src=new">
      ...
      <div class="main_container">
        ...
        <div class="top_nav">
          <div class="nav_menu" style="height:50px">
            <nav>
            <h2 style="margin:15px;float:left"> <Strong>Créer dossier patient:</Strong> </h2>
                         ...
                         <div class="col-md-8 col-xs-12" style="width:100%" >
                            ...
                            <div class="x_panel" style="border-color: #000000;border-radius:20px;background:#EEEEEE">
                                  ...
                                  <hr  style="color:black; margin: 3px">
                                    ...
                                    <input type="text" class="form-control has-feedback-left" id="nom_patient" name="nom_patient"  placeholder="Nom du patient" >
                                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                     </div>
									 
									 <div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" id="prenom_patient" name="prenom_patient"  placeholder="Prénom du patient" >
                                    <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                     </div>
									 
									 <div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="date" class="form-control has-feedback-left" name="date_naissance_patient" id="date_naissance_patient"   >
                                    ...
                                    <span class="fa fa-envelope form-control-feedback left" aria-hidden="true"></span>                            
									 ...
									 <div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" name="tel_patient" id="tel_patint"  placeholder="Téléphone1" >
                                    ...
                                    <span class="fa fa-home form-control-feedback left" aria-hidden="true"></span>
									 ...
									 <div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="text" class="form-control has-feedback-left" name="wilaya_patient" id="wilaya_patient"  placeholder="Wilaya">
                                    <span class="fa fa-home form-control-feedback left" aria-hidden="true"></span>
                                     </div>
									 <div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
